<template>
  <div class="audio-wrapper">
    <form class="controls">
    <div>
      <label for="setting">Musix setting</label>
      <select id="setting" name="setting">
        <option value="record">New Record</option>
        <option value="recognition" selected>Song Recognition</option>
        <option value="off">Off</option>
      </select>
    </div>
    <div>
      <a class="toggle-play-pause">Pause</a>
    </div>
    </form>
  </div>
</template>
...
<script>
import app from '../scripts/audioApp';
